...
Gem::Specification.new do |s|
  ...
  s.files = [
    "VERSION.yml",
     ...
     "generators/talia_base/templates/app/views/sources/semantic_templates/default/province.html.erb",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activerdf_net7>, [">= 1.6.11"])
      ...
      s.add_dependency(%q<activerdf_net7>, [">= 1.6.11"])
